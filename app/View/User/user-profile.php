                ...
                <div class="grid grid-cols-12 items-center justify-center p-4 gap-4">
                    <form action="/user/profile" method="post" class="col-span-12 flex flex-col items-center justify-center gap-2 z-0" enctype="multipart/form-data">
                        <div class="relative inset-0 col-span-12 mx-auto text-center mb-5">
                            <!-- <div class="relative"> -->
                            <img src="<?= getUploadedImg("profile/" . $model['user_profile']) ?? '' ?>" alt="" id="profile_img" class="object-cover object-center h-48 w-48 border-4 border-abu rounded-full">
                        ...
                        <p class="col-span-12 border-2 border-abu p-3 rounded-lg w-full overflow-hidden bg-dark-white"><?= $model['user']->email ?? $model['user_email']?></p>
                        <input class="border-2 border-abu p-3 rounded-lg w-full mb-4" type="text" value="<?= $model['user']->name ?? $model['user_name'] ?>" name="name" required>
                        <div>
