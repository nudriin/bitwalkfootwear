    ...
    <div class="container justify-center w-full p-4 mx-auto mb-12">
        ...
        <div class="w-9/12 mx-auto">
            ...
            <?php if (isset($model['cart']) && $model['cart'] != null  && !isset($model['error'])) { ?>
                ...
                <div class="items-center justify-center w-full h-[400px] p-6 mx-auto mt-12 overflow-hidden border-2 rounded-lg shadow-lg border-abu lg:w-9/12">
                    ...
                    <form action="/user/cart" method="post" enctype="multipart/form-data">
                        ...
                        <h1 class="font-medium text-center">BRI : 4552 0102 4954 539 an Nurdin</h1>
                        <div class="flex flex-col items-center justify-center">
                            <input type="file" name="payment" class="overflow-hidden border-2 rounded-lg font-rubik text-abu border-abu file:bg-merah file:border-0 file:text-white file:font-rubik" required>
                        </div>
                        <button type="submit" class="w-full px-4 py-3 mt-4 font-semibold text-center rounded-lg bg-merah text-dark-white">
                            Checkout
                        </button>
