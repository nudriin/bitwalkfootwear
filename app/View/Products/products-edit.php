                        ...
                        <div class="h-full rounded-lg py-10 shadow-xl">
                            <form method="post" action="/admin/products/edit/<?= $model['products']->id ?>" enctype="multipart/form-data">
                                <div class="flex flex-col w-9/12 mx-auto gap-2">
                                    ...
                                    <input type="text" name="products_name" class="font-rubik bg-dark-white py-2 rounded-md px-4" required placeholder="Nama produk" value="<?= $model['products']->name ?>">
                                </div>
                                <div class="flex flex-col w-9/12 mx-auto gap-2">
                                    <img src="<?= getUploadedImg("products/" . $model['products']->images) ?>" alt="" id="profile_img" class="object-cover object-center h-64 w-full">
                                ...
                                <div class="flex flex-col w-9/12 mx-auto gap-2">
                                    ...
                                    <input type="number" name="products_price" class="font-rubik bg-dark-white py-2 rounded-md px-4" required placeholder="Harga produk" value="<?= $model['products']->price ?>">
                                </div>
                                <div class="flex flex-col w-9/12 mx-auto gap-2">
                                    <label for="judul" class="font-semibold">Stok</label>
                                    <input type="number" name="products_quantity" class="font-rubik bg-dark-white py-2 rounded-md px-4" required placeholder="Stok" value="<?= $model['products']->quantity ?>">
                                </div>
                                <div class="flex flex-col w-9/12 h-48 mx-auto gap-2">
                                    <label for="judul" class="font-semibold mt-2">Deskripsi produk</label>
                                    <textarea name="products_description" id="" cols="30" rows="10" class="bg-dark-white font-rubik rounded-md px-4" required placeholder="Deskripsi produk"><?= $model['products']->description ?></textarea>
                                </div>
                                <!-- <div class="flex flex-col w-9/12 mx-auto gap-2">
                                ...
                                <div class="w-9/12 mx-auto mt-4">
                                    <button class="bg-merah px-9 py-2 rounded-lg font-semibold text-white" type="submit">Ubah</button>
                                </div>
                            </form>
