...
class DetailTransactionsService
{
    ...
    public function displayAllByUserTransactions(DetailTransactionsDisplayByUserRequest $request): DetailTransactionsDisplayByUserResponse
    {
        try {
            $detailTransactions = $this->detailTransactionsRepository->findAllByAccountId($request->account_id);
            if ($detailTransactions == null) {
                throw new ValidationException("Belum ada pesanan apapun");
            }
