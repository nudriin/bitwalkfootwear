...
<body class="text-abu font-poppins" x-data="{profileOpen : false}">
    ...
    <nav x-data="{navOpen : false}" class="px-4 py-5">
        <div class="fixed top-0 left-0 right-0 z-50 items-center justify-center px-4 py-4 mx-auto shadow-md bg-hero-bg">
            <div class="container mx-auto lg:px-20">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="/" class="font-rubik text-abu sm:order-2">Paper Rex</a>
                        <img src="<?= getImage("logo/paper_rex.jpg") ?>" class="object-cover object-center w-8 h-8 rounded-full sm:order-1">
                    </div>
