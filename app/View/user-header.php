...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="http://localhost/images/logo/HeroLogo1.jpg">
...
<body class="text-abu font-poppins" x-data="{profileOpen : false}">
    ...
    <nav x-data="{navOpen : false}" class="px-4 py-5">
        <div class="fixed top-0 left-0 right-0 z-50 items-center px-4 py-4 mx-auto bg-hero-bg">
            <div class="container mx-auto lg:px-20">
                <div class="flex flex-row items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="/" class="font-rubik text-abu sm:order-2">Bitwalk Footwear</a>
                        <img src="<?= getImage("logo/paper_rex.jpg") ?>" class="object-cover object-center w-10 h-10 rounded-full sm:order-1">
                    </div>
                    <div class="items-center hidden mb-2 lg:block">
                        <ul class="flex flex-row items-center gap-5 mt-2 text-abu">
                            <li><a href="/">Beranda</a></li>
                            <li><a href="/shop">Toko</a></li>
                            <li><a href="/user/statistics">Order</a></li>
                        </ul>
                    </div>
            ...
            <div class="fixed top-0 left-0 z-50 w-64 h-screen duration-200 transform -translate-x-full lg:hidden" :class="{'translate-x-0' : navOpen === true, '-translate-x-full' : navOpen === false}">
                <div class="h-full px-4 py-4 bg-dark-white">
                    <div class="flex items-center w-full px-3 py-2 space-x-2 font-medium text-center rounded-xl font-rubik">
                        <span class="flex-1 font-medium text-left font-rubik text-md text-merah">Bitwalk Footwear</span>
                    ...
                    <ul class="py-4 space-y-3">
                        ...
                        <li class="border-2 border-abu rounded-xl">
                            <a href="/user/profile" class="flex items-center w-full px-3 py-2 space-x-2 font-medium text-center group rounded-xl font-rubik hover:bg-merah hover:text-dark-white">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                        ...
                        <li class="border-2 border-abu rounded-xl">
                            <a href="/user/password" class="flex items-center w-full px-3 py-2 space-x-2 font-medium text-center group rounded-xl font-rubik hover:bg-merah hover:text-dark-white">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                        ...
                        <li class="border-2 rounded-xl">
                            <a href="/user/logout" class="flex items-center w-full px-3 py-2 space-x-2 font-medium text-center bg-merah group rounded-xl font-rubik hover:bg-red-500 hover:text-dark-white">
                                <!-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                                    <path fill-rule="evenodd" d="M8 7a5 5 0 113.61 4.804l-1.903 1.903A1 1 0 019 14H8v1a1 1 0 01-1 1H6v1a1 1 0 01-1 1H3a1 1 0 01-1-1v-2a1 1 0 01.293-.707L8.196 8.39A5.002 5.002 0 018 7zm5-3a.75.75 0 000 1.5A1.5 1.5 0 0114.5 7 .75.75 0 0016 7a3 3 0 00-3-3z" clip-rule="evenodd" />
                                </svg> -->
                                <span>Logout</span>
