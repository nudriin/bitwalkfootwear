            ...
            <div class="rounded-lg w-full lg:w-9/12 mx-auto bg-white shadow-xl">
                <form action="/admin/password" method="post" class="flex flex-col gap-3">
                    ...
                    <div class="flex items-center justify-center mb-4 px-4 mt-4">
                        <button type="submit" class="font-semibold text-dark-white text-center bg-merah rounded-lg text-xl w-full p-2" onclick="alert('Anda yakin ingin mengubah password')">Ganti</button>
                    </div>
                </form>
            </div>
        </div>
